-- ==============================================================
-- KỊCH BẢN TẠO DỮ LIỆU MẪU (SEED DATA) CHO SNAPIFY
-- Đã cập nhật theo Kiến trúc Document Scanner Mới Nhất
-- ==============================================================

-- 1. Xóa dữ liệu cũ (Xóa theo thứ tự ngược lại để không dính Foreign Key)
SET FOREIGN_KEY_CHECKS = 0;
TRUNCATE TABLE search_histories;
-- ĐÃ XÓA DÒNG NÀY: TRUNCATE TABLE batch_items;
